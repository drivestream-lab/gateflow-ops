...
import { ClosureLaneTable } from "@/components/lanes/closure-lane-table";
import { getSession } from "@/lib/auth";
import { getEnteredProgrammeContext } from "@/lib/programme-context";
import { isTenantAdmin } from "@/lib/session-role";
import { t } from "@/lib/i18n";

export default async function InitiativeClosurePage() {
  ...
  return (
    <>
      <PageHeader
        title={t("initiative-closure.page.title")}
        description={t("initiative-closure.page.description")}
      />
      <PageBody>
        <ClosureLaneTable />
      </PageBody>
