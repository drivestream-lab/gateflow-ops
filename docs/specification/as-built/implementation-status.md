...
| INIT-GATEFLOW-016 W1 CAP-C wave operations                  | 🔧 implemented    | unit `run-stop-presentation.test.ts`; live `tests/verify/03-w1-wave-operations.md`                                                                    |

_Product waves W2–W4 not started — see initiative as-built detail._
