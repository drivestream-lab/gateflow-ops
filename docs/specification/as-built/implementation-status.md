...
| INIT-GATEFLOW-016 W2 CAP-F initiative tracking              | 🔧 implemented    | unit `initiative-composition.test.ts`; live `tests/verify/04-w2-initiative-tracking.md` (human at wave-acceptance)                                    |
