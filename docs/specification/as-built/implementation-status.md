...
| INIT-GATEFLOW-016 W4 CAP-D/E checkpoints + board            | ✅ human_approved | unit `checkpoint-miss.test.ts`, `board-helpers.test.ts`; live `tests/verify/06-w4-checkpoints-board.md`; ground `Ground-Report-INIT-GATEFLOW-016-W4.md`        |
| INIT-GATEFLOW-017 W0 programme-context chassis              | 🔧 implemented    | See `Implementation-Status-INIT-GATEFLOW-017.md`; unit `programme-context.test.ts`, `auth-login-upstream.test.ts`; live `tests/verify/01-login-status-page.md` |
