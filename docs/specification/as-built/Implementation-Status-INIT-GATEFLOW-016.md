...
| ---- | -------------------------------------------------------------------------------------------- | ---------------------------------------- | ------------------------------------------------------------------------------------------------ |
| W0   | CAP-A tenant detail + invite; CAP-B programme onboarding + pass/fail verdict; WorkspaceShell | 🟡 implemented — pending `wave-accepted` | unit: `tests/unit/onboarding-verdict.test.ts`; live: `tests/verify/02-w0-identity-onboarding.md` |
