...
| W2    | CAP-F initiative tracking                                                                             | 🔧 implemented (awaiting wave-acceptance) | unit: `tests/unit/initiative-composition.test.ts`; live: `tests/verify/04-w2-initiative-tracking.md`                                              |
