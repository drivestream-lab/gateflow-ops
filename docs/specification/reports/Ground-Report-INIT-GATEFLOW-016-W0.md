...
| Date              | 2026-08-12                                                                                                                        |
| Wave head (exact) | `feature/INIT-GATEFLOW-016-w0-identity-onboarding` @ `9c6c23d4373393644ac4dd567de68aebabaf733f` — reviewed head for sign-off      |
...
- PR URL / wave head: https://github.com/drivestream-lab/gateflow-ops/pull/26 @ `9c6c23d4373393644ac4dd567de68aebabaf733f` — **expected reviewed head SHA** (pre-closeout publish may advance tip with this report)
...
handoff:
  ...
  signals:
    ...
    assigned_reqs:
      ...
      - REQ-07
      - REQ-08
    tip_sha: 9c6c23d4373393644ac4dd567de68aebabaf733f
