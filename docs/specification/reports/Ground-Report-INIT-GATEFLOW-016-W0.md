...
| Date              | 2026-08-12                                                                                                                        |
| Wave head (exact) | `feature/INIT-GATEFLOW-016-w0-identity-onboarding` @ `d1971e53c81cfe26a12c1c3b6080030209c33adc` — reviewed head for sign-off      |
...
- PR URL / wave head: https://github.com/drivestream-lab/gateflow-ops/pull/26 @ `d1971e53c81cfe26a12c1c3b6080030209c33adc` — **expected reviewed head SHA** (pre-closeout publish may advance tip with this report)
...
handoff:
  ...
  signals:
    ...
    assigned_reqs:
      ...
      - REQ-07
      - REQ-08
    tip_sha: d1971e53c81cfe26a12c1c3b6080030209c33adc
